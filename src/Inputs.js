...
import React, {useEffect} from 'react';
  ...
  return <>
    <div className="row">
      <div className="column" style={{width:'10em'}}>
        <label>A: <input type="number" value={aval} onChange={(e) => setAval(e.target.value)}></input></label>
  ...
  <div className="row">
      <div className="column" style={{width:'10em'}}>
        <label>C: <input type="number" value={cval} onChange={(e) => setCval(e.target.value)}></input></label>
      </div><div className="column">
